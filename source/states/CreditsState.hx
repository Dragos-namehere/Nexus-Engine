...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		returnTimer.start(0.08, function(timer:FlxTimer) {
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			["Nexus Engine Team"],
			["Dragos",		"dragos",		"Main Proggramer, Modder",					"https://www.youtube.com/@JustDragosrandom",	"52ff4f"],
			["Snare",		"snare",		"Animator, Helper",					"https://soundcloud.com/snarelol",	"ffa533"],
			[""],
			["Special thanks to:"],
			["An Ammar",		"ammar",		"Inspiration, cool guy",					"https://www.youtube.com/@AnAmmar",	"17ff1b"],
			[""],
			["Psych Engine Team"],
			...
			[""],
			["Discord Servers"],
			["Join the Nexus Server", "discord", "", "https://discord.gg/tDVPe8aawU", "5165F6"],
